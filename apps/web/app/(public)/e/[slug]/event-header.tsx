          ...
          <div className="flex shrink-0 items-center gap-2">
            ...
            {ticketsAnchor && (
              <a
                ...
                className="inline-flex items-center gap-1.5 rounded-full bg-primary px-4 py-2 text-xs font-semibold text-primary-foreground transition-colors hover:bg-primaryho md:px-5"
              >
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-[60] bg-white dark:bg-blackho lg:hidden">
          ...
          <nav className="flex flex-col gap-1 overflow-y-auto px-5 pb-8 pt-4">
            ...
            <a
              href={`/client?event=${encodeURIComponent(slug)}`}
              className="mt-6 inline-flex items-center justify-center gap-1.5 rounded-full bg-primary px-5 py-3 text-sm font-semibold text-primary-foreground"
            >
