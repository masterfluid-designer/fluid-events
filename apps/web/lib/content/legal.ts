...
export const publisher = {
  ...
  registration: "en cours d'immatriculation",
...
export const legalNoticeContent = {
  ...
  intro:
    "Informations relatives à l'éditeur et à l'hébergeur du site fluidevent.online.",
  sections: [
    {
  ...
  sections: [
    {
      ...
      paragraphs: [
        "Nous collectons uniquement ce qui est nécessaire au fonctionnement de la billetterie :",
      ],
      bullets: [
